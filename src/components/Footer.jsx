const Footer = () => {
  ...
  <img className="fill-current m-auto sm:m-0" width="50" height="50" src="https://img.icons8.com/?size=50&id=2025&format=png&color=a6adbb" alt="pen"/>
    ...
    <p className="self-center text-center sm:text-left">
      <span className="uppercase">Personal Diary</span>
      <br />
      Represented by Julia, Yongqi, Kemal & Konstantin
    </p>
  </div>
  <nav className="sm:w-1/4 w-full justify-center sm:justify-end">
    <h6 className="footer-title text-center sm:text-left w-full">Social Media</h6>
